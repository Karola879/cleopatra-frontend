        ...
        <div className="main-page">
            <div className="content">
                ...
                <p>
                    ...
                    <ul>
                        <li>Zabiegi na twarz, które pomagają utrzymać młody wygląd skóry, poprawiają jej jędrność i nawilżenie, a także niwelują zmarszczki i inne niedoskonałości. Dzięki nowoczesnym technologiom i wysokiej jakości kosmetykom, nasze terapie przynoszą szybkie i trwałe efekty.</li>
                        <li>Zabiegi na ciało – od relaksujących masaży, przez modelowanie sylwetki, aż po oczyszczanie i nawilżanie skóry. Każdy zabieg jest dopasowany do Twoich indywidualnych potrzeb, a nasza oferta obejmuje również zabiegi detoksykacyjne i redukcji cellulitu.</li>
                        <li>Depilacja – bezpieczne i skuteczne usuwanie zbędnego owłosienia za pomocą najnowszych technologii, w tym depilacji laserowej. Z nami zapomnisz o tradycyjnych metodach depilacji i poczujesz się gładko przez długi czas.</li>
                        <li>Stylizacja paznokci – zarówno klasyczne manicure i pedicure, jak i nowoczesne zdobienia paznokci, w tym manicure hybrydowy, żelowy czy przedłużanie paznokci. W trosce o Twoje zdrowie, używamy tylko bezpiecznych i wysokiej jakości produktów.</li>
                    </ul>
                </p>
                <p>
                ...
                <h2>Dlaczego warto wybrać Cleopatra Beauty Salon?</h2>
                <ol>
                    <li>Doświadczenie i profesjonalizm – Nasi specjaliści to osoby z pasją i doświadczeniem, które z zaangażowaniem podchodzą do każdego Klienta.</li>
                    <li>Indywidualne podejście – Każdy zabieg jest dopasowany do Twoich potrzeb i oczekiwań.</li>
                    <li>Nowoczesne technologie – Korzystamy z najnowszych osiągnięć kosmetologii, aby zapewnić Ci najlepsze efekty.</li>
                    <li>Bezpieczeństwo i komfort – Zapewniamy wysoki standard higieny i komfortu, by każda wizyta była przyjemnością.</li>
                </ol>
                <p>
